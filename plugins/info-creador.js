...
*${bot} (bot)*`
  let teks = ' '
const sections = [{title: `𝑇𝑖𝑜 𝑁𝑒𝑙/𝑁𝑒𝑙𝐵𝑒𝑟`, rows: [{title: "🔰 • 595986102574", rowId: ".owner bio"}, {title: "🌐 • CUENTAS OFICIALES", rowId: ".cuentasgb"}, {title: "🙌 • GRUPOS", rowId: ".grupos"},]}, {title: `–––––––·• 𝘼𝙋𝙊𝙔𝘼 𝘼𝙇 𝘽𝙊𝙏 –––––––·•`, rows: [ {title: "🤖 • INSTALARBOT", rowId: ".instalarbot"}, {title: "🌟 • SC", rowId: "Sc"}, ]}, ]
