...
🔸 apt update -y && yes | apt upgrade && pkg install -y bash wget mpv && wget -O - https://raw.githubusercontent.com/elrebelde21/NelBer-Bot-MD/master/install.sh | bash

📌 *𝙊𝙋𝘾𝙄𝙊𝙉: 2 𝘼𝙍𝘾𝙃𝙄𝙑𝙊*
*https://youtu.be/i1xjB4bmc*
...
𝙉𝙚𝙡𝘽𝙚𝙧-𝘽𝙤𝙩 : 𝙏𝙪𝙩𝙤𝙧𝙞𝙖𝙡
https://youtu.be/Xp2jR_v8o?si=𝙫-𝙍𝙠𝙔𝙮𝙍𝙅4𝙨𝙚𝙩𝙫𝙟
...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: texto, contextInfo: { externalAdReply: { title: 'ᴛʜᴇ-ʟᴏʟɪʙᴏᴛ-ᴍᴅ', body: null, thumbnail: imagen1, sourceUrl: 'https://youtu.be/gh5NajZOA8' }, mentionedJid: [m.sender] }}}, aa)
