...
let menu = `『 ${wm} 』
┌───⊷───────────────
┆•Hola ${taguser} yo me llamo 𝙉𝙚𝙡𝘽𝙚𝙧-𝘽𝙤𝙩 y estoy para ayudarte${usedPrefix}
┆•Objetivo: ayudar a ahorrar saldo usando el pack whatsapp ilimitado${usedPrefix}
└───────────────────
┌───⊷_*TU INFO ACTUAL ES👇*_
┆┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
...
${readMore}
└────────────────
┌───⊷ *COMO UNIR EL BOT A TU GRUPO?👇*
┆┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
┆ 🤖 _*~AGREGA A TU GRUPO EL NUMERO DE 𝙉𝙚𝙡𝘽𝙚𝙧-𝘽𝙤𝙩 y LISTO~*_
└─────────────
┌───⊷ *BUSCA O INVESTIGA COSAS CON INTELIGENCIA ARTIFICIAL*
┆  •Nota: *el uso que le des, queda a tu criterio/No abusar👇*
┆┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
┆🤖 _${usedPrefix}chatgpt *seguido de tu pregunta o búsqueda*_
┆🤖 _${usedPrefix}chatbot *seguido de tu pregunta o búsqueda*_
└─────────────
┌───⊷ *HACÉ DESCARGAS DIRECTAS DESDE TU WHATSAPP CON LOS SIGUIENTES COMANDOS👇*
┆┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
...
└─────────────
┌───⊷ *DESCARGA APLICACIONES DIRECTO CON TU WHATSAPP CON EL SIGUIENTE COMANDO👇SEGUIDO DEL NOMBRE DE LA APP QUE QUIERES*
┆┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
┆📥 _${usedPrefix}playstore *<texto>*_
└─────────────
┌───⊷ *GRUPOS*
┆ *Mejorá tu Grupo con 𝙉𝙚𝙡𝘽𝙚𝙧-𝘽𝙤𝙩👇*
┆┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
...
└─────────────
┌───⊷ *JUEGOS*
┆ *conando para la diversión de tu Grupo👇*
┆┈┈┈┈┈┈┈┈┈┈┈┈┈┈
...
┆ *Compra, Adquiere Recursos*
┆ *Mejora Tu Nivel y Rango!!👇*
┆┈┈┈┈┈┈┈┈┈┈┈┈┈┈
...
└─────────────
┌───⊷
□ *COMO INSTALAR EL BOT ESCRIBÍME👇*
┆┈┈┈┈┈┈┈┈┈┈┈┈┈┈
